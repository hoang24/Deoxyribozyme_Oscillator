...
thold = 150;
numPerturb = (T - t) / thold; % number of period that the chemistry is perturbed until the Tth second
...
while (t < T)
   ...
   if (t >= tPerturb)
       ...
       Sm1 = Sm_base * rand;
       Sm2 = Sm_base * rand;
       Sm_table(perturbCount, :) = [Sm1, Sm2, Sm3];
   end
...
save(fileName, 'summaryTable', 'tPerturb_vec', 'Sm_table', 'numIteration', 'tElapsed');
